...
const mockDealsB = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 96,
    highlightTags: ["Fast payout", "High limit"],
    status: "active",
    statusLabel: "Đang hoạt động",
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
  ...
  {
    id: "deal_b_004",
    dealCode: "DL-B-VND-USD-004",
    ownerNameMasked: "Sophia ***",
    ownerInitial: "S",
    rating: 4.8,
    reviewCount: 73,
    highlightTags: ["Best rate", "High limit"],
    status: "active",
    statusLabel: "Đang hoạt động",
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
    exchangeRate: { from: "USD", to: "VND", rate: 25580, source: "custom", updatedAt: "2026-06-17T08:45:00Z" },
    amountLimit: { minUsd: 100, maxUsd: 3500 },
    beneficiaryReceiveMethod: "Zelle",
    beneficiaryAccountId: "acc_b_us_zelle_001",
    senderPaymentMethods: ["MoMo", "Bank Transfer"],
    note: "Ưu tiên giao dịch nhanh, xác nhận proof trong 10 phút.",
  ...
  },
  {
    ...
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
    exchangeRate: { from: "USD", to: "VND", rate: 25520, source: "market", updatedAt: "2026-06-17T09:10:00Z" },
    amountLimit: { minUsd: 25, maxUsd: 500 },
    beneficiaryReceiveMethod: "PayPal",
    beneficiaryAccountId: "acc_b_us_paypal_001",
    senderPaymentMethods: ["MoMo", "ZaloPay"],
    note: "Phù hợp giao dịch nhỏ, hỗ trợ MoMo và ZaloPay.",
  ...
  {
    id: "deal_b_006",
    dealCode: "DL-B-VND-USD-006",
    ownerNameMasked: "Michael ***",
    ownerInitial: "M",
    rating: 4.9,
    reviewCount: 55,
    highlightTags: ["High limit"],
    status: "active",
    statusLabel: "Đang hoạt động",
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
    exchangeRate: { from: "USD", to: "VND", rate: 25620, source: "custom", updatedAt: "2026-06-17T09:35:00Z" },
    amountLimit: { minUsd: 500, maxUsd: 12000 },
    beneficiaryReceiveMethod: "Bank Transfer",
    beneficiaryAccountId: "acc_b_us_bank_001",
    senderPaymentMethods: ["Bank Transfer"],
    note: "Limit cao cho giao dịch doanh nghiệp, ưu tiên chuyển khoản ngân hàng.",
  ...
  },
  {
    ...
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
    exchangeRate: { from: "USD", to: "VND", rate: 25490, source: "market", updatedAt: "2026-06-17T10:05:00Z" },
    amountLimit: { minUsd: 75, maxUsd: 1500 },
    beneficiaryReceiveMethod: "Zelle",
    beneficiaryAccountId: "acc_b_us_zelle_001",
    senderPaymentMethods: ["ZaloPay", "Bank Transfer"],
    note: "Có thể chia nhỏ giao dịch, hỗ trợ ZaloPay hoặc bank.",
  ...
  },
  {
    ...
    beneficiaryReceiveCurrency: { currency: "USD", country: "US", label: "USD - Đô la Mỹ" },
    senderPayCurrency: { currency: "VND", country: "VN", label: "VND - Việt Nam Đồng" },
    exchangeRate: { from: "USD", to: "VND", rate: 25540, source: "custom", updatedAt: "2026-06-17T10:25:00Z" },
    amountLimit: { minUsd: 150, maxUsd: 4200 },
    beneficiaryReceiveMethod: "PayPal",
    beneficiaryAccountId: "acc_b_us_paypal_001",
    senderPaymentMethods: ["MoMo", "Bank Transfer"],
    note: "Tỷ giá ổn định, phù hợp giao dịch vừa và xác nhận trong ngày.",
...
const overviewData = {
  ...
  marketSnapshot: {
    ...
    high: 25730,
    points: [
      { label: "11/06", value: 25300 },
      { label: "12/06", value: 25420 },
      { label: "13/06", value: 25520 },
      { label: "14/06", value: 25490 },
      { label: "15/06", value: 25620 },
      { label: "16/06", value: 25700 },
      { label: "17/06", value: 25640 },
    ],
  },
  ...
  recentHistory: [
    ...
    { id: "txn_005", transactionCode: "TXN-20260616-004", name: "Minh *** B", status: "processing", statusLabel: "Đang xử lý", sendAmount: "300", sendCurrency: "USD", receiveAmount: "7,650,000", receiveCurrency: "VND", time: "Hôm qua, 10:18", method: "Zelle" },
    ...
    { id: "txn_007", transactionCode: "TXN-20260614-003", name: "Lan *** H", status: "rejected", statusLabel: "Từ chối", sendAmount: "200", sendCurrency: "USD", receiveAmount: "5,110,000", receiveCurrency: "VND", time: "15/06/2026, 17:22", method: "ZaloPay" },
